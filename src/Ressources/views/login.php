...
<!--===============================================================================================-->	
	<link rel="icon" type="../../../web/login/image/png" href="../../../web/login/images/icons/favicon.ico"/>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="../../../web/login/fonts/iconic/css/material-design-iconic-font.min.css">
<!--===============================================================================================-->
...
<body>
	...
	<div class="container-login100" style="background-image: url('../../../web/login/images/img6.jpg')">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30" style="background-image: url('../../../web/login/images/img9.jpg')">
			<form class="login100-form validate-form"  method="post"  action="../control/loginCtr.php?action=connexion">
				...
				<div class="flex-c p-b-112">
					...
					<a href="#" class="login100-social-item">
						<img src="../../../web/login/images/icons/icon-google.png" alt="GOOGLE">
					</a>
				</div>

				<div class="text-center">
					<a href="inscri.php" class="txt2 hov1">
						Sign Up
					</a>
				</div>
			</form>
